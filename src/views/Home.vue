<template>
  <div id="wrapper">
    <div class="intro">
      <div class="description">
					...
					<section class ="intro_text">
						...
						<p>Currently working as a <span class="bold">{{jobTitle}}</span> at <a href="https://www.samsung.com/in/aboutsamsung/home/" class="linking" target="_blank"> {{company}}</a>. I got initiated into design and earned my Bachelor's degree in Design at <a href="https://www.iitg.ac.in/design/" class="linking" target="_blank">Indian Institute of Technology, Guwahati.</a></p>
            <br>
            <p class="links"> <a href="mailto:poulamichakraborty11@gmail.com">E-mail</a>&#8226; <a href="https://www.linkedin.com/in/poulamichakraborty/">LinkedIn</a>.</p>
          </section>
			</div>
		</div>
    ...
    <div class="body">
      <section id="projects">
        <article v-for="project in projects" :key ="project.title"> <a v-bind:href=project.url v-on:click.stop.prevent="goToProject(project.url)">
          <img :src = "project.image">
          <div class="project_description">
            <h2>{{project.title}}</h2>
            <p class="secondary">{{project.subtitle}}</p>
          </div>
          </a>
        </article>
      </section>
...
export default {
  ...
  methods: {
    goToProject (purl) {
      this.$router.push({name: purl, params: {PId: purl}})
      //console.log(purl)
    }
  }
}
